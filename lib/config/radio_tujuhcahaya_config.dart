...
class RadioTujuhCahayaConfig {
  ...
  static const String stationTitle = 'UpRadio Semarang';
  ...
  static const String? logoNetworkUrl =
      null; // Will be implemented via server configuration
  ...
  static const String? azuracastStationId =
      null; // Set via server configuration

  /// Apple Music/iTunes configuration
  static const bool enableAppleMusicFallback = true;

  /// Fallback artwork configuration
  ...
  static const int audioSessionOptimizationDelayMs =
      200; // 200ms delay for audio session
